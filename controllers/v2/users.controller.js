...
exports.createUser = async (req, res) => {
  ...
  try {
    ...
    if (!username || !name || !email || !password) {
      return res.json({
        message: 'Missing required fields: username, name, email, and password are all necessary to create a user.'
      });
    }
...
exports.updateByUser = async (req, res) => {
  ...
  try {
    ...
    const { username, name, email, role, oldPassword, newPassword, team } = req.body;
